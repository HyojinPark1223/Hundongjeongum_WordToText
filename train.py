...
def trainIters(encoder, decoder, n_iters=int, print_every=1000, plot_every=1000, learning_rate=0.01,max_length = int):
    start = time.time()
    plot_losses = []
...
losses = trainIters(encoder1, decoder1, n_iters = 6000, print_every=1000,plot_every =1000,max_length = output_max_len)

torch.save(encoder1.state_dict(),'encoder4.pth')
torch.save(decoder1.state_dict(),'decoder4.pth')
